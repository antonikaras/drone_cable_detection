...
(cl:defmethod cl:initialize-instance :after ((m <target_global_pos-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'target_global_pos-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drone_cable_detection-srv:<target_global_pos-request> is deprecated: use drone_cable_detection-srv:target_global_pos-request instead.")))

(cl:ensure-generic-function 'goal_pos-val :lambda-list '(m))
(cl:defmethod goal_pos-val ((m <target_global_pos-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_cable_detection-srv:goal_pos-val is deprecated.  Use drone_cable_detection-srv:goal_pos instead.")
  (goal_pos m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<target_global_pos-request>)))
  ...
  "drone_cable_detection/target_global_posRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'target_global_pos-request)))
  "Returns string type for a service object of type 'target_global_pos-request"
  "drone_cable_detection/target_global_posRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <target_global_pos-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'target_global_pos-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drone_cable_detection-srv:<target_global_pos-response> is deprecated: use drone_cable_detection-srv:target_global_pos-response instead.")))

(cl:ensure-generic-function 'dist-val :lambda-list '(m))
(cl:defmethod dist-val ((m <target_global_pos-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_cable_detection-srv:dist-val is deprecated.  Use drone_cable_detection-srv:dist instead.")
  (dist m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<target_global_pos-response>)))
  ...
  "drone_cable_detection/target_global_posResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'target_global_pos-response)))
  "Returns string type for a service object of type 'target_global_pos-response"
  "drone_cable_detection/target_global_posResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'target_global_pos)))
  ...
  "drone_cable_detection/target_global_pos")