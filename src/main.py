...
def main():
    ...
    #setpoint_msg.pose.velocity.z = 1
    #setpoint_msg.velocity.z = 1
    ...
    while (True):
        ...
        # Make a circle
        setpoint_msg.pose.position.x = 2 * math.sin(rospy.get_time() * 0.2)
        setpoint_msg.pose.position.y = 2 * math.cos(rospy.get_time() * 0.2)
